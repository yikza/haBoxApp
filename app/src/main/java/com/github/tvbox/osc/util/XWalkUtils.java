...
public class XWalkUtils {
    ...
    public static String downUrl() {
        return String.format("https://download.01.org/crosswalk/releases/crosswalk/android/stable/latest/%s/crosswalk-apks-23.53.589.4-%s.zip", getRuntimeAbi(), getRuntimeAbi());
    }
